...
import sample.view.FDAlert.TeamNameOrHomeTownFDAlert;
import sample.view.PaginatedTable;

public class FindTeamNameOrHomeTownFDAlert extends TeamNameOrHomeTownFDAlert {

    private final PaginatedTable table = new PaginatedTable(new Controller());
    private final Button findButton = new Button("Найти");

    public FindTeamNameOrHomeTownFDAlert() {
